const About = () => {
  const skills = [
    { id: 1, category: 'Frontend', items: ['React', 'NextJS', 'TypeScript', 'Tailwind CSS', 'Shadcn', 'Grommet', 'Jotai', 'Zustand', 'Tanstack/React Query', 'Axios'] },
    { id: 2, category: 'Backend', items: ['Node.js', 'Express', 'NextJS', 'PostgreSQL - Supabase', 'MongoDB'] },
